...
<img src="pic/03-1.1_1.png" width=100%>  

- 有向图(无权)的邻接矩阵  
<img src="pic/03-1.1_2.png" width=100%>  
(1)有向图的邻接矩阵不一定对称，有n个定点的有向图需要的存储空间为n^2;
(2)有向图中，定点Vi的**出度**是邻接矩阵中**第i行**元素之和，顶点Vi的**入度**是邻接矩阵中**第i列**的元素之和；
- 带权有向图的邻接矩阵
<img src="pic/03-1.1_3.png" width=100%>  
- 邻接矩阵的数据类型定义  
```c
...
- 无向图的邻接表  
<img src="pic/03-1.2_1.png" width=100%>
- 无权有向图的邻接表
<img src="pic/03-1.2_2.png" width=100%>
- 带权有向图的邻接表 
<img src="pic/03-1.2_3.png" width=100%>  
...
## **2.1 BFS遍历**
- 过程分析  
<img src="pic/03-2.1_1.png" width=100%>
